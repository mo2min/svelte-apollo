...
<main>
  ...
  <div
    class="flex bg-blue-600 text-white text-sm font-bold px-4 py-3"
    role="alert">
    <svg
      class="fill-current text-yellow-300 w-4 h-4 mr-2"
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 20 20">
      <path
        d="M12.432 0c1.34 0 2.01.912 2.01 1.957 0 1.305-1.164 2.512-2.679
        2.512-1.269 0-2.009-.75-1.974-1.99C9.789 1.436 10.67 0 12.432 0zM8.309
